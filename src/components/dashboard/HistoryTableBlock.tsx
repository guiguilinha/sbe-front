    ...
    <Card className="rounded-xl overflow-hidden">
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base md:text-lg">Histórico de resultados</CardTitle>
          {viewAllHref && (
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {rows.map((r, i) => {
              ...
              console.log(`🔑 HistoryTableBlock - Key gerada para row: ${key}`);
              return (
                ...
                <td className="px-4 py-2">
                  <a href={r.detailsUrl} className="inline-flex items-center gap-1 text-blue-700 hover:underline">
